...
const sdk = window.DID_SDK
// 2. Paste the `data-agent-id' in the 'agentId' variable
let agentId = "agt_cduxIicz"

// 3. Paste the 'data-client-key' in the 'auth.clientKey' variable
let auth = {type: 'key', clientKey: "Z29vZ2xlLW9hdXRoMnwxMTE0ODI1MjkxNzM1NzMzODI3NTU6V0N0eURmcndiZWdsYmtwN2tyYmN5"};
